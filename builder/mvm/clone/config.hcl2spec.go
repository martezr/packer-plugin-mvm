...
type FlatConfig struct {
	...
	ServicePlanID             *int64            `mapstructure:"plan_id" cty:"plan_id" hcl:"plan_id"`
	CloudID                   *int64            `mapstructure:"cloud_id" cty:"cloud_id" hcl:"cloud_id"`
	GroupID                   *int64            `mapstructure:"group_id" cty:"group_id" hcl:"group_id"`
	NetworkID                 *int64            `mapstructure:"network_id" cty:"network_id" hcl:"network_id"`
}
