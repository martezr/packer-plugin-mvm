...
<!-- Code generated from the comments of the NetworkInterface struct in builder/mvm/clone/config.go; DO NOT EDIT MANUALLY -->

- `network_id` (int64) - Network Id

- `network_interface_type_id` (int64) - Network Interface Type Id

<!-- End of code generated from the comments of the NetworkInterface struct in builder/mvm/clone/config.go; -->
